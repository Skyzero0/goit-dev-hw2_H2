...
Компанія MegaSoft, яка розробляє програмне забезпечення на замовлення. Спрощена модель роботи виглядає наступним чином:
...
-
Файл init_db.sql, у якому змодельована структура бази даних для компанії MegaSoft згідно брифінгу. Мають бути наступні таблиці:
...
=
Файл populate_db.sql, у якому SQL для заповнення таблиць. Після виконання SQL БД має бути приведена у наступний стан:
...
=
Файл find_max_salary_worker.sql. У ньому SQL, який виведе працівника з найбільшою заробітною платою. Якщо таких працівників декілька - потрібно вивести всіх.
...
=
Файл find_max_projects_client.sql. У ньому SQL, який виведе клієнта з найбільшою кількістю проєктів. Якщо таких клієнтів декілька - потрібно вивести всіх.
...
=
Файл find_longest_project.sql. У ньому SQL, який виведе проєкт з найбільшою тривалістю в місяцях. Якщо таких проєктів декілька - потрібно вивести всі ці проєкти.
...
=
Файл find_youngest_eldest_workers.sql. У ньому SQL, який вибере наймолодшого та найстаршого працівників, та виведе їх у форматі таблиці з наступними полями:
...
=
Файл print_project_prices.sql. У ньому SQL, який виведе список проєктів та вартість кожного проєкту.
...
Відсортувати проєкти по спаданню - спочатку найдорожчі проєкти.
...
=
Створити новий репозиторій на GitHub. Додати туди всі створені .sql файли.
